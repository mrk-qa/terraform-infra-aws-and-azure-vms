...
run "loading_module_random_for_azure" {
  module {
    source = "./tests/modules/random"
  }
}

run "test_validation_resource_group_azure" {
  command = plan

  variables {
    rg_name_azure = "rg-vm-tf-github-${run.loading_module_random_for_azure.random_id}"
    tag_id_azure = {
      owner      = "marco-${run.loading_module_random_for_azure.random_id}"
      managed-by = "terraform-${run.loading_module_random_for_azure.random_id}"
    }
    location_azure = run.loading_module_random_for_azure.region_types_azure
  }

  assert {
    condition     = azurerm_resource_group.resource_group.name == "rg-vm-tf-github-${run.loading_module_random_for_azure.random_id}"
    error_message = "Resource group name did not match expected"
  }

  assert {
    condition     = azurerm_resource_group.resource_group.location == lower(run.loading_module_random_for_azure.region_types_azure)
    error_message = "Resource group location did not match expected"
  }

  assert {
    condition     = azurerm_resource_group.resource_group.tags == tomap({ owner = "marco-${run.loading_module_random_for_azure.random_id}", managed-by = "terraform-${run.loading_module_random_for_azure.random_id}" })
...
run "test_validation_public_ip_azure" {
  ...
  variables {
    public_ip_name_azure = "public-ip-terraform-github-${run.loading_module_random_for_azure.random_id}"
    tag_id_azure = {
      owner      = "marco-${run.loading_module_random_for_azure.random_id}"
      managed-by = "terraform-${run.loading_module_random_for_azure.random_id}"
    }
  ...
  assert {
    condition     = azurerm_public_ip.public_ip.name == "public-ip-terraform-github-${run.loading_module_random_for_azure.random_id}"
  ...
  assert {
    condition     = azurerm_public_ip.public_ip.location == lower(run.loading_module_random_for_azure.region_types_azure)
    error_message = "Public IP location did not match expected"
  }

  assert {
    condition     = azurerm_public_ip.public_ip.tags == tomap({ owner = "marco-${run.loading_module_random_for_azure.random_id}", managed-by = "terraform-${run.loading_module_random_for_azure.random_id}" })
...
run "test_validation_network_interface_azure" {
  ...
  variables {
    network_interface_name_azure = "nic-tf-github-${run.loading_module_random_for_azure.random_id}"
    ip_configuration_name_azure  = "public-ip-terraform-github-${run.loading_module_random_for_azure.random_id}"
    tag_id_azure = {
      owner      = "marco-${run.loading_module_random_for_azure.random_id}"
      managed-by = "terraform-${run.loading_module_random_for_azure.random_id}"
    }
  ...
  assert {
    condition     = azurerm_network_interface.network_interface.name == "nic-tf-github-${run.loading_module_random_for_azure.random_id}"
    error_message = "Network interface name did not match expected"
  }

  assert {
    condition     = azurerm_network_interface.network_interface.ip_configuration[0].name == "public-ip-terraform-github-${run.loading_module_random_for_azure.random_id}"
  ...
  assert {
    condition     = azurerm_network_interface.network_interface.tags == tomap({ owner = "marco-${run.loading_module_random_for_azure.random_id}", managed-by = "terraform-${run.loading_module_random_for_azure.random_id}" })
...
run "test_validation_vm_azure" {
  ...
  variables {
    vm_name_azure           = "vm-terraform-github-${run.loading_module_random_for_azure.random_id}"
    vm_size_azure           = run.loading_module_random_for_azure.instance_types_azure
    vm_admin_username_azure = run.loading_module_random_for_azure.admin_username_azure
    tag_id_azure = {
      owner      = "marco-${run.loading_module_random_for_azure.random_id}"
      managed-by = "terraform-${run.loading_module_random_for_azure.random_id}"
    }
  ...
  assert {
    condition     = azurerm_linux_virtual_machine.vm.name == "vm-terraform-github-${run.loading_module_random_for_azure.random_id}"
  ...
  assert {
    condition     = azurerm_linux_virtual_machine.vm.location == lower(run.loading_module_random_for_azure.region_types_azure)
    error_message = "Virtual Machine location did not match expected"
  }

  assert {
    condition     = azurerm_linux_virtual_machine.vm.size == run.loading_module_random_for_azure.instance_types_azure
    error_message = "Virtual Machine size did not match expected"
  }

  assert {
    condition     = azurerm_linux_virtual_machine.vm.admin_username == run.loading_module_random_for_azure.admin_username_azure
  ...
  assert {
    condition     = azurerm_linux_virtual_machine.vm.tags == tomap({ owner = "marco-${run.loading_module_random_for_azure.random_id}", managed-by = "terraform-${run.loading_module_random_for_azure.random_id}" })
